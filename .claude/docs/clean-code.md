...
- **Abstraction:** DRY but don't over-abstract. Delete dead code. Comment only WHY. Prefer well-named methods over comments. **No Javadoc** — well-named types, methods, and tests are the documentation; for public HTTP APIs use OpenAPI annotations, not Javadoc.
